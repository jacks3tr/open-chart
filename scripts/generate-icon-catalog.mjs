...
function renderCatalogModule(simpleIconsLibrary, phosphorLibrary) {
  return [
    '// Generated by scripts/generate-icon-catalog.mjs. Do not edit.',
    '// Regenerate after updating the pinned icon packages.',
    `export const simpleIconsLibrary = ${JSON.stringify(simpleIconsLibrary)};`,
    `export const phosphorLibrary = ${JSON.stringify(phosphorLibrary)};`,
    '',
  ].join('\n');
}
